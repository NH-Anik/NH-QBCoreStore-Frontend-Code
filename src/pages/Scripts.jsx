...

                          {
                            products.map((items, key) => (   
                              ...
                              <div key={key} className="w-full sm:w-1/2 md:w-1/3 lg:w-[32%] bg-navup border border-sky-500 borderGlow">
                                  <div className="p-2">
                                      <ModalImage className="object-cover object-center w-full h-64 lg:h-80" small={`${baseUrl}/api/v1/product/product-photo/${items._id}`} large={`${baseUrl}/api/v1/product/product-photo/${items._id}`} alt/>
                                      ...
                                      <div className="my-2">
                                          ...
                                          <p className="text-white">{items.description.substring(0, 40)}...</p>
                                      </div>
