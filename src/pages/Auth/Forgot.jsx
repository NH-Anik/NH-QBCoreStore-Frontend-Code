              ...
              <div className="flex justify-around flex-wrap">
                  ...
                  <div className="w-[600px]">
                    <div className="space-y-6" >
                      <h5 className="text-xl font-medium text-white dark:text-white">Forgot Password</h5>

                      <div>
                        <label htmlFor="email" className="block text-white mb-2 text-sm font-medium  dark:text-white">Your email</label>
                        ...
                        <p className="text-red-700 mt-1">{emailerror}</p>
                      </div>

                      <button onClick={handelforgot} className="w-full text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 ">
                          {
                      ...
                      <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                        Not registered? <Link to={'/registration'} className="text-green-700 hover:underline dark:text-green-500">Create account</Link>
                      </div>
                    </div>
                  </div>
              </div>
                      ...
                      <div className="flex flex-col bg-black max-w-md gap-2 p-6 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100">
                          <div className="rounded-md shadow-lg px-4 py-6">
                            ...
                            <div>
                              ...
                              <input onChange={handlNewPassword} type="password"  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Enter your new password" />
                            ...
                            <div>
                              ...
                              <input onChange={handlConfirmNewPassword} type="password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Enter your new password" />
