        ...
        <Layout title={"Create Admin Account"}>
            <div className='max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8'>
                <div className='flex'>
                    ...
                    <div>
                        <div>
                            <h1 className="text-3xl text-center text-white">Create Admin Registration</h1>
                        </div>
                        ...
                        <form className="space-y-6" onSubmit={handelsubmit}>
                          ...
                          <div className="mt-2">
                            <label htmlFor="role" className="block mb-2 text-sm font-medium text-gray-300 dark:text-white">Role</label>
                            <input onChange={handelRole} type="number" min={0} max={1} name="role" id="role" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="user(0) or admin(1)" />
                            <p className="text-red-700 text-sm mt-2">{roleError}</p>
                          </div>
