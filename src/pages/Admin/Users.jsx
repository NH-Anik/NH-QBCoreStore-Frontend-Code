        ...
        <Layout title={"Users Admin Dashboard"}>
            {
                ...
                <div className='max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8'>
                    <div className='flex'>
                        ...
                        <div>
                            <div>
                                <h1 className="text-3xl text-center text-white"> Admin Users List</h1>
                            </div>
                                            ...
                                            allUsers.map((item,key) => (
                                                <tr key={key}>
                                                    <td className="flex items-center gap-x-3 py-3 px-6 whitespace-nowrap">
                                                        ...
                                                        <div>
                                                            <span className="text-white block text-sm font-medium">{item.name}</span>
                                                        </div>
                                                    </td>
                                                    <td className="text-white px-6 py-4 whitespace-nowrap">{item.email}</td>
                                                    <td className="text-white px-6 py-4 whitespace-nowrap">{item.role}</td>
                                                    <td className="text-white px-6 py-4 whitespace-nowrap capitalize">{item.address}</td>
                  ...
                  <div className="fixed inset-0 bg-black bg-opacity-25 backdrop-blur-sm flex items-center justify-center">
                      <div className="flex flex-col bg-black max-w-md gap-2 p-6 rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100">
                          <div className="rounded-md shadow-lg px-4 py-6">
                              ...
                              <h6 className="text-lg text-center text-white mt-2">Are you sure ? make Admin</h6>
